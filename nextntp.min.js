...
function alert(options) {
		var t = this;
		t.count = 0, t.timeout = options.timeout ? options.timeout : 3e3, t.autoClose = !options.hasOwnProperty("autoClose") || options.autoClose;
		const close = '<svg class="_icon" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>';
		t.container = document.querySelector("#nt1"), t.close = function ($el) {
				$el.classList.add("animate-out"), setTimeout(() => {
						$el.remove(), t.count--
				}, 300)
				...
				return span.textContent = message, item.appendChild(span), t.count++, item
				...
				console.log(t.autoClose), t.autoClose && t.setAutocloseTimeout(l, t.timeout), t.setCloseOnClick(l), t.container.append(l)
		}
}
...
function adaptColor(selector, color) {
		...
		var result = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(color),
				hsp;
		r = parseInt(result[1], 16), g = parseInt(result[2], 16), b = parseInt(result[3], 16), Math.sqrt(r * r * .299 + g * g * .587 + b * b * .114) > 127.5 ? (document.getElementById(selector).classList.add("dark_c"), document.getElementById(selector).classList.remove("light_c")) : (document.getElementById(selector).classList.add("light_c"), document.getElementById(selector).classList.remove("dark_c"))
}

function arrayBufferToBase64(buffer) {
		var binary = "",
				bytes;
		return [].slice.call(new Uint8Array(buffer)).forEach(b => binary += String.fromCharCode(b)), window.btoa(binary)
}
...
function pagesRoute() {
		...
		if (link) {
				const navigate = id => {
						...
						activePage && activePage.classList.remove("page-active"), activeLink && activeLink.classList.remove("active");
						var nextPage = document.querySelector(id),
								nextLink = document.querySelector("[topage='" + id + "']");
						nextPage && nextPage.classList.add("page-active"), nextLink && nextLink.classList.add("active")
				};
...
function preconnectTo(url) {
		...
		hint.rel = "preconnect", hint.href = url, document.head.appendChild(hint)
}
...
function modal(id) {
		var t = this;
		t.m = document.querySelector(id || ".modal"), t.m && (t.bdy = document.body.classList, t.targets = document.querySelectorAll('[data-toggle="' + t.m.id + '"]'), t.closebtns = t.m.querySelectorAll(".close-modal")), t.toggle = () => {
		...
		var q, V, Z, $, Q, J, tt, et, nt, ot, it, rt, at, lt, st, ct, ut, dt, ht, ft, pt, gt, mt, vt, bt, yt = !1,
				...
				It = function (t, e) {
						...
						return "flex" === n.display ? "column" === n.flexDirection || "column-reverse" === n.flexDirection ? "vertical" : "horizontal" : "grid" === n.display ? n.gridTemplateColumns.split(" ").length <= 1 ? "vertical" : "horizontal" : i && a.float && "none" !== a.float ? (e = "left" === a.float ? "left" : "right", !r || "both" !== l.clear && l.clear !== e ? "horizontal" : "vertical") : i && ("block" === a.display || "flex" === a.display || "table" === a.display || "grid" === a.display || o <= s && "none" === n[Mt] || r && "none" === n[Mt] && o < s + t) ? "vertical" : "horizontal"
				},
				Pt = function (t) {
						function l(r, a) {
								return function (t, e, n, o) {
										var i = t.options.group.name && e.options.group.name && t.options.group.name === e.options.group.name;
										return !(null != r || !a && !i) || null != r && !1 !== r && (a && "clone" === r ? r : "function" == typeof r ? l(r(t, e, n, o), a)(t, e, n, o) : (e = (a ? t : e).options.group.name, !0 === r || "string" == typeof r && r === e || r.join && -1 < r.indexOf(e)))
								}
						}
						var e = {},
								n = t.group;
		...
		function Ft(t, e, n, o, i, r, a, l) {
				...
				return !window.CustomEvent || y || w ? (s = document.createEvent("Event")).initEvent("move", !0, !0) : s = new CustomEvent("move", {
						bubbles: !0,
						cancelable: !0
				}), s.to = e, s.from = t, s.dragged = n, s.draggedRect = o, s.related = i || e, s.relatedRect = r || k(e), s.willInsertAfter = l, s.originalEvent = a, t.dispatchEvent(s), d ? d.call(u, s, a) : c
		}
		...
		xt && document.addEventListener("click", (function (t) {
				...
				_onTouchMove: function (t) {
						if (st) {
								var e, n = (e = this.options).fallbackTolerance,
										o = e.fallbackOffset,
				...
				_onDragOver: function (n) {
						...
						if (!Ct) {
								...
								if (wt = !1, c && !e.disabled && (u ? d || (i = V !== $) : lt === this || (this.lastPutMode = at.checkPull(this, c, q, n)) && s.checkPut(this, c, q, n))) {
										...
										var g;
										if (!(g = Y(a, e.draggable)) || function (t, e, n) {
														return n = k(Y(n.el, n.options.draggable)), e ? t.clientX > n.right + 10 || t.clientX <= n.right && t.clientY > n.bottom && t.clientX >= n.left : t.clientX > n.right && t.clientY > n.top || t.clientX <= n.right && t.clientY > n.bottom + 10
												}(n, r, this) && !g.animated) {
												if (g === q) return O(!1);
												if ((l = g && a === n.target ? g : l) && (w = k(l)), !1 !== Ft($, a, q, o, l, w, n, !!l)) return x(), a.appendChild(q), V = a, M(), O(!0)
										} else if (g && function (t, e, n) {
														return n = k(X(n.el, 0, n.options, !0)), e ? t.clientX < n.left - 10 || t.clientY < n.top && t.clientX < n.right : t.clientY < n.top - 10 || t.clientY < n.bottom && t.clientX < n.left
												}(n, r, this)) {
												var m;
												...
												var v, b, y, w = k(l),
														...
														S = r ? "top" : "left",
														g, m = (g = R(l, "top", "top") || R(q, "top", "top")) ? g.scrollTop : void 0;
												if (gt !== l && (b = w[S], Dt = !1, St = !D && e.invertSwap || E), 0 !== (v = function (t, e, n, o, i, r, a, l) {
																...
																if (!a)
																		if (l && vt < c * i) {
																				if (Dt = !Dt && (1 === mt ? t + c * r / 2 < s : s < o - c * r / 2) || Dt) n = !0;
																				else if (1 === mt ? s < t + vt : o - vt < s) return -mt
																		} else if (t + c * (1 - i) / 2 < s && s < o - c * (1 - i) / 2) return function (t) {
																		return B(q) < B(t) ? 1 : -1
																}(e);
																return (n = n || a) && (s < t + c * r / 2 || o - c * r / 2 < s) ? t + c / 2 < s ? 1 : -1 : 0
												...
												var C = (gt = l).nextElementSibling,
														E = !1,
														D;
												if (!1 !== (D = Ft($, a, q, o, l, w, n, E = 1 === v))) return 1 !== D && -1 !== D || (E = 1 === D), Ct = !0, setTimeout(Ht, 30), x(), E && !C ? a.appendChild(q) : l.parentNode.insertBefore(q, E ? C : l), g && F(g, 0, m - g.scrollTop), V = q.parentNode, void 0 === b || St || (vt = Math.abs(b - k(l)[S])), M(), O(!0)
										}
		...
		ne.prototype = {
				...
				onSpill: function (t) {
						var e = t.dragEl,
								n = t.putSortable;
						this.sortable.captureAnimationState(), n && n.captureAnimationState(), (t = X(this.sortable.el, this.startIndex, this.options)) ? this.sortable.el.insertBefore(e, t) : this.sortable.el.appendChild(e), this.sortable.animateAll(), n && n.animateAll()
				},
				drop: n
		}, a(ne, {
		...
		function pe(n, o) {
				ue.forEach((function (t, e) {
						(e = o.children[t.sortableIndex + (n ? Number(e) : 0)]) ? o.insertBefore(t, e): o.appendChild(t)
				}))
		}
...
function theme() {
		...
		if (window.CSS && CSS.supports("color", "var(--bg)") && toggles) {
				...
				document.getElementById("sett_mtc").style.background = mtc.light, document.getElementById("sett_mtc1").style.background = mtc.dark, storedTheme && document.body.setAttribute("data-theme", storedTheme), "light" === storedTheme ? metaTColor.setAttribute("content", mtc.light) : metaTColor.setAttribute("content", mtc.dark);
				for (var i = 0; i < toggles.length; i++) toggles[i].onclick = function () {
						var currentTheme, targetTheme = "light";
						"light" === document.body.getAttribute("data-theme") ? (targetTheme = "dark", metaTColor.setAttribute("content", mtc.dark)) : metaTColor.setAttribute("content", mtc.light), document.body.setAttribute("data-theme", targetTheme), localStorage.setItem("theme", targetTheme)
				}
		}
}
document.getElementById("export-data").onclick = function () {
		...
		Object.keys(localStorage).forEach(key => {
				safeData.includes(key) && (console.log(key), dataStr[key] = localStorage.getItem(key))
		});
		var dataUri = "data:application/json;charset=utf-8," + encodeURIComponent(JSON.stringify(dataStr)),
				date = new Date,
				exportFileDefaultName = "ntpB_" + date.getUTCFullYear() + (date.getUTCMonth() + 1) + date.getUTCDate() + "_" + date.getHours() + "_" + date.getMinutes() + ".json",
		...
		var dataStr = {};
		Object.keys(localStorage).forEach(key => {
				safeDataT.includes(key) && (console.log(key), dataStr[key] = localStorage.getItem(key))
		});
		var dataUri = "data:application/json;charset=utf-8," + encodeURIComponent(JSON.stringify(dataStr)),
				date = new Date,
				exportFileDefaultName = "nextntp_theme" + date.getUTCFullYear() + (date.getUTCMonth() + 1) + date.getUTCDate() + "_" + date.getHours() + "_" + date.getMinutes() + ".json",
				linkElement = document.createElement("a");
		linkElement.setAttribute("href", dataUri), linkElement.setAttribute("download", exportFileDefaultName), linkElement.click()
		...
		reader.onload = function (progressEvent) {
				...
				}), Object.assign(localStorage, data), console.log(localStorage), localStorage.ntp_ver = ntp_ver
		}, reader.readAsText(file), location.reload()
		...
		reader.onload = function (progressEvent) {
				...
				}), console.log(data), Object.assign(localStorage, data), console.log(localStorage), localStorage.ntp_ver = ntp_ver
		}, reader.readAsText(file), location.reload()
};
const isTD = is_td();
...
if (wcentp) {
		document.body.style.backgroundImage = "none", document.body.style.backgroundColor = "#000", document.getElementById("incognito").style.display = "inline", document.getElementById("ntp_cnt").style.display = "none";
		var inc = !1
} else {
		var ntp_ver = "3.7.0",
				orderListChanged = 0;
		...
		document.getElementById("sett_mtc").style.background = localStorage.ntp_mtc, localStorage.ntp_ver == ntp_ver && localStorage.ntp_ver || (localStorage.clear(), localStorage.ntp_ver = ntp_ver);
		...
		function f_dwdg(i) {
				...
				switch (i) {
						case 0:
								chd = '<div id="sb_r"><img id="sb_logo" alt=""><div class="sb_wrap"><span id="sb_icon_default"></span><ul id="sb_icon_menu"> </ul><input name="sb_input" type="text" id="sb_input" size="50" spellcheck="false" onkeydown="handleKeyPress(event)"></div></div>';
								break;
						case 1:
		...
		null == ntp_wdg && (console.log("Create default cached widgets... "), localStore("ntp_wdg", ntp_wdg = [{
				name: "Search Bar",
				cached: f_dwdg(0)
		}, {
				name: "Tiles Grid",
		...
		for (var i = 0; i < 6; i++) {
				...
				if (2 == i)
						for (var ar = document.getElementsByClassName("tile_target"), z = 0; z < ar.length; z++) ar[z].target = b;
				f_trim(a.value.toString()) == f_trim(b.toString()) ? a.checked = !0 : a.checked = !1
		}

		function set_option_t(t, f, i) {
				console.log("status :" + t.checked + " value : " + t.value + " if false : " + f + ", index " + i);
				var value = t.checked ? t.value : f;
				ntp_bdy.style.setProperty("--o" + i, value), 2 == i && setTileTarget("_self" == targetBlank ? "_blank" : "_self"), save_ntpbdy()
		}

		function f_update_font() {
				var font = document.getElementById("font-selector").value;
				ntp_bdy.style.setProperty("--custom-font", font), save_ntpbdy(), console.log(font)
		}
		...
		null != ntp_sb && null != ntp_sb.se && null != ntp_sb.placeholder || localStore("ntp_sb", ntp_sb = {
				se: {
						Google: !0,
						Bing: !0,
						Brave: !0,
		...
		if (null == sb_icon_default) {
				const y = ntp_sett.order[0];
				customInner(document.getElementById("wdg_" + y), f_dwdg(0)), ntp_wdg[0].cached = document.getElementById("wdg_" + y).innerHTML, localStore("ntp_wdg", ntp_wdg)
		}

		function hide_dropdown() {
				sb_dropdown_menu.classList.remove("active"), document.removeEventListener("click", hide_dropdown)
		}
		...
		function render_se_list() {
				...
				}), se_keys.length != Object.keys(ntp_sb.se) && (se_keys = Object.keys(ntp_sb.se), localStore("ntp_sb", ntp_sb));
				...
				se_keys.forEach((el, index) => {
						...
						if (null != se_icon) {
								var setChecked = 1 == se_status ? "checked" : "",
										...
										noshadow = "";
								"#ffffff" == se_icon[0] && (noshadow = "box-shadow:none;"), li.innerHTML = '<svg class="_icon stt_selisth" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zm-3.707 9.293a1 1 0 011.414 0L10 14.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg><div class="sb_item"><span class="sb_icon" style="background: ' + se_icon[0] + ";" + noshadow + '"> ' + se_icon[1] + "</span>" + el + '</div><input class="toggle" type="checkbox" onchange="toggle_se_status(\'' + el + "')\" " + setChecked + " />", list.appendChild(li)
						} else if (se_custom = ntp_sb.custom_se[el], null != se_custom) {
								var setChecked = 1 == se_status ? "checked" : "",
										li;
								(li = document.createElement("li")).innerHTML = '<svg class="_icon stt_selisth" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zm-3.707 9.293a1 1 0 011.414 0L10 14.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg><div class="sb_item"><span class="sb_icon" style="background: ' + se_custom[0] + ' "> ' + se_custom[1] + "</span>" + el + "</div><svg onclick=\"sb_delete_se('" + el + '\')" class="_icon" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg><input class="toggle" type="checkbox" onchange="toggle_se_status(\'' + el + "')\" " + setChecked + " />", list.appendChild(li)
						} else console.log(se_custom, el)
				})
		}

		function sb_delete_se(a) {
				console.log(ntp_sb.custom_se), delete ntp_sb.custom_se[a], delete ntp_sb.se[a], localStore("ntp_sb", ntp_sb), render_se_list(), f_setup_sb()
		}

		function toggle_se_status(key_name) {
				console.log(key_name);
				const se_status = ntp_sb.se[key_name];
				ntp_sb.se[key_name] = !se_status, f_setup_sb(), localStore("ntp_sb", ntp_sb)
		}

		function f_trim(s) {
				return s = (s = (s = s.replace(/(^\s*)|(\s*$)/gi, "")).replace(/[ ]{2,}/gi, " ")).replace(/\n /, "\n")
		}
		sb_custom_form.addEventListener("submit", e => {
				var name = f_trim(document.getElementById("custom_sb_name").value),
						query = f_trim(document.getElementById("custom_sb_query").value),
						color = f_trim(document.getElementById("custom_sb_color").value),
						svg = document.getElementById("custom_sb_svg").value;
				return name.length < 1 && query.length < 1 && color.length < 1 && svg.length < 1 ? ntoast.error("You need to complete all the rquired fields ") : (ntp_sb.se[name] = !0, ntp_sb.custom_se[name] = [color, svg, query], localStore("ntp_sb", ntp_sb), f_setup_sb(), render_se_list(), ntoast.success("Custom Search Engine added !"), sb_custom_form.reset()), e.preventDefault(), !1
		}), sb_icon_default.addEventListener("click", e => {
				sb_dropdown_menu.classList.contains("active") ? sb_dropdown_menu.classList.remove("active") : (sb_dropdown_menu.classList.add("active"), e.stopPropagation(), document.addEventListener("click", hide_dropdown))
		}), render_se_list(), Sortable.create(document.getElementById("stt_selist"), {
				handle: ".stt_selisth",
				animation: 150,
				onEnd: function (evt) {
						for (var se_list = {}, list = document.getElementById("stt_selist").getElementsByTagName("li"), z = 0; z < list.length; z++) {
								var a = list[z].innerText,
										s = list[z].querySelector("input").checked;
								se_list[a] = s
						}
						ntp_sb.se = se_list, console.log(ntp_sb), localStore("ntp_sb", ntp_sb), f_setup_sb()
				}
		});
		...
		var tms_0 = parseInt(ntp_bdy.style.getPropertyValue("--tms0").replace("px", "")),
				tms_1 = parseInt(ntp_bdy.style.getPropertyValue("--tms1").replace("px", "")),
				tms_2 = parseInt(ntp_bdy.style.getPropertyValue("--tms2").replace("px", ""));
		isNaN(tms_0) && (tms_0 = 10, ntp_bdy.style.setProperty("--tms0", " 10px"), save_ntpbdy()), isNaN(tms_1) && (tms_1 = 10, ntp_bdy.style.setProperty("--tms1", " 10px"), save_ntpbdy()), isNaN(tms_2) && (tms_2 = 10, ntp_bdy.style.setProperty("--tms2", " 10px"), save_ntpbdy()), tms_r0.value = tms_0, tms_r1.value = tms_1, tms_r2.value = tms_2, tms_r0v.innerText = tms_0, tms_r1v.innerText = tms_1, tms_r2v.innerText = tms_2, tms_r0.addEventListener("input", (function () {
				tms_0 = parseInt(tms_r0.value), tms_r0v.innerText = tms_0, ntp_bdy.style.setProperty("--tms0", tms_0 + "px"), save_ntpbdy()
		})), tms_r1.addEventListener("input", (function () {
				tms_1 = parseInt(tms_r1.value), tms_r1v.innerText = tms_1, ntp_bdy.style.setProperty("--tms1", tms_1 + "px"), save_ntpbdy()
		})), tms_r2.addEventListener("input", (function () {
				tms_2 = parseInt(tms_r2.value), tms_r2v.innerText = tms_2, ntp_bdy.style.setProperty("--tms2", tms_2 + "px"), save_ntpbdy()
		}));
		...
		tg_r5vs.innerText = tg_r5v, isNaN(tg_r5v) && (tg_r5v = 8, tg_r5vs.innerText = tg_r5v, ntp_bdy.style.setProperty("--v0", tg_r5v + "px"), save_ntpbdy()), tg_r5.value = tg_r5v, tg_r5.addEventListener("input", (function () {
				tg_r5v = parseInt(tg_r5.value), tg_r5vs.innerText = tg_r5v, ntp_bdy.style.setProperty("--v0", tg_r5v + "px"), save_ntpbdy()
		}));
		...
		tg_r7vs.innerText = tg_r7v, isNaN(tg_r7v) && (tg_r7v = 8, tg_r7vs.innerText = tg_r7v, ntp_bdy.style.setProperty("--v2", tg_r7v + "px"), save_ntpbdy()), tg_r7.value = tg_r7v, tg_r7.addEventListener("input", (function () {
				tg_r7v = parseInt(tg_r7.value), tg_r7vs.innerText = tg_r7v, ntp_bdy.style.setProperty("--v2", tg_r7v + "px"), save_ntpbdy()
		}));
		...
		tg_r8vs.innerText = tg_r8v, isNaN(tg_r8v) && (tg_r8v = 10, tg_r8vs.innerText = tg_r8v, ntp_bdy.style.setProperty("--v3", tg_r8v + "px"), save_ntpbdy()), tg_r8.value = tg_r8v, tg_r8.addEventListener("input", (function () {
				tg_r8v = parseInt(tg_r8.value), tg_r8vs.innerText = tg_r8v, ntp_bdy.style.setProperty("--v3", tg_r8v + "px"), save_ntpbdy()
		}));
		...
		tg_r6vs.innerText = tg_r6v, isNaN(tg_r6v) && (tg_r6v = 230, tg_r6vs.innerText = tg_r6v, ntp_bdy.style.setProperty("--v1", tg_r6v + "px"), save_ntpbdy()), tg_r7.setAttribute("max", tg_r6v / 2), tg_r6.value = tg_r6v, tg_r6.addEventListener("input", (function () {
				tg_r6v = parseInt(tg_r6.value), tg_r6vs.innerText = tg_r6v, ntp_bdy.style.setProperty("--v1", tg_r6v + "px"), save_ntpbdy()
		}));
		...
		function f_sb_lg1() {
				...
				if (file && file.type.match("image.*")) {
						...
						reader.onload = function (e) {
								ntp_bdy.style.setProperty("--sb-img-l", "url(" + e.target.result + ")"), ntp_bdy.style.setProperty("--sb-img-d", "var(--sb-img-l)"), save_ntpbdy()
		...
		function f_sb_lg2() {
				var url = prompt("Enter url of the wallpaper . \nExample : ", "url"),
						img = new Image;
				img.crossOrigin = "Anonymous", img.onload = function (e) {
						var canvas = document.createElement("canvas"),
								ctx;
						canvas.width = img.width, canvas.height = img.height, canvas.getContext("2d").drawImage(img, 0, 0);
						var dataURL = canvas.toDataURL("image/png");
						dataURL.replace(/^data:image\/(png|jpg);base64,/, ""), ntp_bdy.style.setProperty("--sb-img-l", "url(" + dataURL + ")"), ntp_bdy.style.setProperty("--sb-img-d", "var(--sb-img-l)"), save_ntpbdy()
				}, img.src = url
		}
		if (ntp_sett.status[0]) {
				function f_cache_sb() {
						const y = ntp_sett.order[0];
						ntp_wdg[0].cached = document.getElementById("wdg_" + y).innerHTML, console.log("Cache search bar"), localStore("ntp_wdg", ntp_wdg)
				}

				function f_setup_sb() {
						sb_dropdown_menu.innerHTML = "", Object.keys(ntp_sb.se).forEach((el, index) => {
								const se_status = ntp_sb.se[el];
								var se_icon = se_data_icons[el];
								if (null == se_icon && (se_icon = ntp_sb.custom_se[el]), null != se_icon && se_status) {
										var si = document.createElement("li");
										si.setAttribute("data-se", el), si.addEventListener("click", event => {
												var q = sb_dropdown_menu.querySelector("li.active_sb");
												null != q && q.classList.remove("active_sb"), event.target.classList.add("active_sb");
												var sei = se_data_icons[event.target.innerText];
												null == sei && (sei = ntp_sb.custom_se[event.target.innerText]), document.getElementById("sb_input").placeholder = ntp_sb.placeholder + " " + event.target.innerText, sb_icon_default.style.background = sei[0], sb_icon_default.innerHTML = sei[1], sb_dropdown_menu.classList.remove("active")
										}), 0 == index && (document.getElementById("sb_input").placeholder = ntp_sb.placeholder + " " + el, sb_icon_default.style.background = se_icon[0], sb_icon_default.innerHTML = se_icon[1], si.className = "active_sb");
										var noshadow = "";
										"#ffffff" == se_icon[0] && (noshadow = "box-shadow:none;"), si.innerHTML = '<span class="sb_icon" style="background: ' + se_icon[0] + ";" + noshadow + ' "> ' + se_icon[1] + "</span> " + el, sb_dropdown_menu.appendChild(si)
								}
						})
				}
		...
		if (ntp_sett.status[1]) {
				var targetBlank = getComputedStyle(ntp_bdy).getPropertyValue("--o2"),
						gridT, fldT, timeoutVariable, currentEditedTile, tlg = document.getElementById("tlg");
				...
				function setTileTarget(value) {
						for (var ar = document.getElementsByClassName("tile_target"), i = 0; i < ar.length; i++) ar[i].target = value;
						targetBlank = value, f_cache_tl()
				}

				function f_cache_tl() {
						if (void 0 === localStorage.cachedGridUpdate || Date.now() / 1e3 - localStorage.cachedGridUpdate >= .1) {
								var y = ntp_sett.order[1];
								ntp_wdg[1].cached = document.getElementById("wdg_" + y).innerHTML, localStorage.cachedGridUpdate = Date.now() / 1e3, console.log("Cache grid tiles : " + localStorage.cachedGridUpdate)
						}
						localStore("ntp_wdg", ntp_wdg)
				}

				function f_dlg(view) {
						0 == view && (dlg_tg.style.display = "inline", dlg_fl.style.display = "none", b_add.style.display = "inline", b_add2.style.display = "none", b_save.style.display = "none"), 4 == view && (dlg_tg.style.display = "inline", dlg_fl.style.display = "none", b_add.style.display = "none", b_add2.style.display = "none", b_save.style.display = "inline"), 2 == view && (dlg_tg.style.display = "none", dlg_fl.style.display = "inline", b_add.style.display = "none", b_add2.style.display = "inline", b_save.style.display = "none"), 5 == view && (dlg_tg.style.display = "none", dlg_fl.style.display = "inline", b_add.style.display = "none", b_add2.style.display = "none", b_save.style.display = "inline"), dlg.show(), document.getElementById("flt_btn").classList.remove("open")
				}

				function f_dlg_close() {
						p_tile.removeAttribute("src"), i_url.value = "", t_url.value = "https://", t_lab.value = "", t_ac.checked = !0, i_url.disabled = !0, b_add.style.display = "inline", b_add2.style.display = "none", b_save.style.display = "none", dlg.hide()
				}

				function f_cnf() {
						var div = document.createElement("div");
						div.classList.add("tlg_item", "folder"), div.innerHTML = '<div class="tlg_img tlg_fld"></div><span id="tlg_span" class="tlg_title">' + ft_lab.value + "</span>", tlg.appendChild(div), f_evl_gtiles(), f_cache_tl(), f_dlg_close()
				}

				function fixURL(value) {
						return value.indexOf("https://") < 0 && value.indexOf("http://") < 0 ? "https://" + value : value
				}
				...
				function f_cnt() {
						...
						"" == title && (title = get_root_domain(newt.url)), newt.title = title, newt.imgSrc = p_tile.src, f_attg(newt), f_dlg_close()
				}
				...
				function f_etfg(item) {
						...
						if (currentEditedTile.classList.contains("folder")) {
								...
								t_ac.checked = !1, i_url.disabled = !1, p_tile.src = img, i_url.value = img, t_url.value = url, t_lab.value = title, f_dlg(4)
						}
				}

				function f_sptt(t) {
						i_url.disabled && (window.clearTimeout(timeoutVariable), timeoutVariable = setTimeout((function () {
				...
				function f_spti(t) {
						window.clearTimeout(timeoutVariable), timeoutVariable = setTimeout((function () {
								p_tile.src = t.value
						}), 1e3)
				}
				...
				function f_sac(e, s) {
						if (1 == s)
								if (i_url.disabled) e.checked = !1, i_url.value = "", i_url.disabled = !1, i_url.select(), i_url.focus();
								else {
										e.checked = !0;
										var iUrl = "https://logos.kiwibrowser.com/" + get_root_domain(t_url.value);
										window.clearTimeout(timeoutVariable), timeoutVariable = setTimeout((function () {
												p_tile.src = iUrl
										}), 1e3), i_url.value = iUrl, i_url.disabled = !0
								}
						else fi_url.disabled ? (e.checked = !0, fi_url.value = "", fi_url.disabled = !1, fi_url.select(), fi_url.focus()) : (e.checked = !1, fi_url.disabled = !0)
				}

				function f_sedt() {
						var item = currentEditedTile;
						for (i = 0, len = tlg.children.length; i < len; i++) tlg.children[i] == item && (index = i);
						if (currentEditedTile.classList.contains("folder")) item.children[1].innerHTML = ft_lab.value;
						else {
								item.querySelector("#tile_target").href = t_url.value;
								const title = t_lab.value;
								"" == title && (title = get_root_domain(newt.url)), item.children[0].children[1].innerHTML = title, item.children[0].children[0].src = p_tile.src
						}
				...
				function f_iimg(item) {
						var parser;
						document.createElement("a").href = t_url.value, item.src = "https://logos.kiwibrowser.com/kiwibrowser.com"
				}

				function f_attg(item) {
						var innerDiv = document.createElement("div");
						innerDiv.className = "tlg_item", innerDiv.innerHTML = '<a id="tile_target" class="tile_target" href="' + item.url + '" ' + targetBlank + ' rel="noreferrer"><img class="tlg_img" src="' + item.imgSrc + '" onError="f_iimg(this)" /><span id="tlg_span" class="tlg_title">' + item.title + "</span></a>", tlg.appendChild(innerDiv), console.log(" Function f_attg -> url : " + item.url + "   |  title : " + item.title + " | img : " + item.imgSrc), f_evl_gtiles(), window.setTimeout((function () {
								f_cache_tl()
						}), 200)
				}
				...
				function f_tggl_f() {
						...
						fldT.option("disabled", !state), document.getElementById("fld_editA").style.display = state ? "flex" : "none", state || (fld_current.innerHTML = fldb.innerHTML, f_cache_tl())
				}

				function f_tggl_t() {
						var state = gridT.option("disabled");
						gridT.option("disabled", !state), document.getElementById("tlg_sldr").style.display = state ? "flex" : "none", document.getElementById("tlg_editA").style.display = state ? "flex" : "none", state || (f_cache_tl(), save_ntpbdy())
				}
				...
				function f_setup_sldr() {
						if (!document.getElementById("tlg_sldr")) {
								var div = document.createElement("div");
								div.id = "tlg_sldr", div.innerHTML = '<div id="sld_tg"><svg class="_icon" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 4a1 1 0 00-2 0v7.268a2 2 0 000 3.464V16a1 1 0 102 0v-1.268a2 2 0 000-3.464V4zM11 4a1 1 0 10-2 0v1.268a2 2 0 000 3.464V16a1 1 0 102 0V8.732a2 2 0 000-3.464V4zM16 3a1 1 0 011 1v7.268a2 2 0 010 3.464V16a1 1 0 11-2 0v-1.268a2 2 0 010-3.464V4a1 1 0 011-1z"></path></svg>书签网格滑块</div><div id="sld_vw" class="flex-column"><div><label>书签块数量 : <span id="tg_r1v"></span> </label><input type="range" min="0" max="8" value="50" class="slr_rng" id="tg_r1"></div><div><label>书签块宽度 : <span id="tg_r2v"></span> </label><input type="range" min="30" max="200" value="50" class="slr_rng" id="tg_r2"></div><div><label>书签块间隔 : <span id="tg_r3v"></span> </label><input type="range" min="0" max="100" value="50" class="slr_rng" id="tg_r3"></div><div><label>书签块圆角: <span id="tg_r4v"></span> </label><input type="range" min="0" max="100" value="50" class="slr_rng" id="tg_r4"></div></div>', tlg.parentNode.prepend(div)
						}
						const wid = (window.innerWidth ? window.innerWidth : screen.width) - 28,
						...
						function setTLG() {
								tg_r1.value = ntp_tlg.n, tg_r2.value = ntp_tlg.w, tg_r3.value = ntp_tlg.m, tg_r4.setAttribute("max", ntp_tlg.w / 2), tg_r4.value = ntp_tlg.r, ntp_bdy.style.setProperty("--tile-n", ntp_tlg.n), ntp_bdy.style.setProperty("--tile-w", ntp_tlg.w + "px"), ntp_bdy.style.setProperty("--tile-m", ntp_tlg.m + "px"), ntp_bdy.style.setProperty("--tile-r", ntp_tlg.r + "px"), save_ntpbdy()
						}

						function f_gncols() {
								return wid > 253 && wid < 337 ? 3 : wid > 336 && wid < 421 ? 4 : wid > 420 && wid < 510 ? 5 : wid > 509 && wid < 672 ? 6 : wid > 671 ? 8 : 2
						}

						function set_tg_r3() {
								for (var tCol = parseInt(ntp_tlg.n), tWidth = parseInt(ntp_tlg.w), tMargin = parseInt(ntp_tlg.m), calc = tCol * (tWidth + tMargin) + 1; calc > wid;) calc = tCol * ((tWidth -= 1) + tMargin) + 1;
								ntp_tlg.n = tCol, ntp_tlg.w = tWidth, ntp_tlg.m = tMargin, setTLG()
						}

						function set_tg_r2() {
								for (var tCol = parseInt(ntp_tlg.n), tWidth = parseInt(ntp_tlg.w), tMargin = 10, calc = tCol * (tWidth + 10) + 1; calc > wid;) calc = (tCol -= 1) * (tWidth + 10) + 1, console.log(wid + " . - " + calc);
								ntp_tlg.n = tCol, ntp_tlg.m = 10, setTLG()
						}

						function set_tg_r1() {
								for (var nCol = parseInt(ntp_tlg.n), tWidth = parseInt(ntp_tlg.w), tMargin = parseInt(ntp_tlg.m), calc = nCol * (tWidth + tMargin) + 1; calc > wid;) calc = nCol * (tWidth + tMargin) + 1, tMargin > 10 ? tMargin -= 1 : tWidth -= 1;
								ntp_tlg.n = nCol, ntp_tlg.m = tMargin, ntp_tlg.w = tWidth, setTLG()
						}
						isNaN(ntp_tlg.w) && (ntp_tlg = {
								w: 64,
								m: 10,
								n: f_gncols(),
								r: 32
						}, setTLG()), tg_r1.value = ntp_tlg.n, tg_r1v.innerText = ntp_tlg.n, tg_r2.value = ntp_tlg.w, tg_r2v.innerText = ntp_tlg.w, tg_r3.value = ntp_tlg.m, tg_r3v.innerText = ntp_tlg.m, tg_r4.setAttribute("max", ntp_tlg.w / 2), tg_r4.value = ntp_tlg.r, tg_r4v.innerText = ntp_tlg.r, tg_r1.addEventListener("input", (function () {
								tg_r1v.innerText = tg_r1.value, ntp_tlg.n = parseInt(tg_r1.value), set_tg_r1()
						})), tg_r2.addEventListener("input", (function () {
								tg_r2v.innerText = tg_r2.value, ntp_tlg.w = parseInt(tg_r2.value), set_tg_r2()
						})), tg_r3.addEventListener("input", (function () {
								tg_r3v.innerText = tg_r3.value, ntp_tlg.m = parseInt(tg_r3.value), set_tg_r3()
						})), tg_r4.addEventListener("input", (function () {
								tg_r4v.innerText = tg_r4.value, ntp_tlg.r = parseInt(tg_r4.value), setTLG()
						}))
				}

				function process_body_click(e) {
						if (e.target == document.getElementById("sld_tg")) return document.getElementById("sld_vw").classList.toggle("open_sld"), void e.preventDefault();
						e.target != document.getElementById("tlg_sldr") ? (gridT.option("disabled") || (document.getElementById("sld_vw").classList.remove("open_sld"), f_tggl_t(), e.preventDefault()), fldT.option("disabled") || (f_tggl_f(), e.preventDefault()), e.target == lrt_fl.m && (lrt_fl.hide(), e.preventDefault())) : e.preventDefault()
				}

				function f_setup_gtiles() {
						if (tlg = document.getElementById("tlg"), !document.getElementById("tlg_editA")) {
								var div = document.createElement("div");
								div.innerHTML = '<div id="tlg_editA" class="edit_mode"><div id="edit_bin"><svg class="_icon" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg></div><div id="edit_pencil" ><svg class="_icon" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path><path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd"></path></svg></div></div>', tlg.parentNode.appendChild(div)
						}
						...
						gridT = new Sortable(tlg, {
								...
								onChange: function (evt) {
										document.getElementById("edit_bin").style.background = "transparent", document.getElementById("edit_pencil").style.background = "transparent", fldtest.forEach(el => {
												el.parentNode.classList.remove("fldHover")
										})
								}
						});
						for (var i = 0; i < fldtest.length; i++) new Sortable(fldtest[i], {
								group: {
										name: "editM",
										pull: "clone"
								},
								...
								onAdd: function (evt) {
										...
										itemEl.parentNode.removeChild(itemEl), fldtest.forEach(el => {
												el.parentNode.classList.remove("fldHover")
										}), document.getElementById("edit_bin").style.background = "transparent", document.getElementById("edit_pencil").style.background = "transparent"
								},
								onChange: function (evt) {
										document.getElementById("edit_bin").style.background = "transparent", document.getElementById("edit_pencil").style.background = "transparent", evt.to.parentNode.classList.add("fldHover")
								}
						});
						new Sortable(document.getElementById("edit_bin"), {
								...
								onAdd: function (evt) {
										var itemEl = evt.item;
										itemEl.parentNode.removeChild(itemEl), (itemEl = evt.clone).parentNode.removeChild(itemEl), document.getElementById("edit_bin").style.background = "transparent"
								},
								onChange: function (evt) {
										fldtest.forEach(el => {
												el.parentNode.classList.remove("fldHover")
										}), document.getElementById("edit_pencil").style.background = "transparent", document.getElementById("edit_bin").style.background = "red"
								}
								...
								onAdd: function (evt) {
										var itemEl, itemEl;
										f_etfg(itemEl = evt.clone), (itemEl = evt.item).parentNode.removeChild(itemEl), document.getElementById("edit_pencil").style.background = "transparent", f_evl_gtiles()
								},
								onChange: function (evt) {
										fldtest.forEach(el => {
												el.parentNode.classList.remove("fldHover")
										}), document.getElementById("edit_bin").style.background = "transparent", document.getElementById("edit_pencil").style.background = "green"
								}
						});
						...
						fldT = new Sortable(fldb, {
								...
								draggable: ".tlg_item",
								onChange: function (evt) {
										edit_b2.style.background = "transparent", edit_p2.style.background = "transparent", edit_o2.style.background = "transparent"
								}
								...
								onAdd: function (evt) {
										var itemEl = evt.item;
										itemEl.parentNode.removeChild(itemEl), (itemEl = evt.clone).parentNode.removeChild(itemEl), edit_b2.style.background = "transparent"
								},
								onChange: function (evt) {
										edit_p2.style.background = "transparent", edit_o2.style.background = "transparent", edit_b2.style.background = "red"
								}
								...
								onAdd: function (evt) {
										var itemEl = evt.item;
										tlg.appendChild(itemEl), (itemEl = evt.clone).parentNode.removeChild(itemEl), edit_o2.style.background = "transparent", f_tggl_f(), f_evl_gtiles()
								},
								onChange: function (evt) {
										edit_b2.style.background = "transparent", edit_o2.style.background = "blue", edit_p2.style.background = "transparent"
								}
								...
								onAdd: function (evt) {
										var itemEl, itemEl;
										f_etfg(itemEl = evt.clone), (itemEl = evt.item).parentNode.removeChild(itemEl), edit_p2.style.background = "transparent", f_evl_gtiles()
								},
								onChange: function (evt) {
										edit_b2.style.background = "transparent", edit_o2.style.background = "transparent", edit_p2.style.background = "green"
								}
						}), f_evl_gtiles(), f_setup_sldr(), window.setTimeout((function () {
								f_cache_tl()
						}), 900)
				}
				document.body.addEventListener("click", process_body_click), f_setup_gtiles()
		}
		if (ntp_sett.status[2]) {
				...
				function shouldIC() {
						...
						if (null == localStorage.shouldIC) return localStorage.shouldIC = date1, !1;
				...
				function f_astd() {
						...
						for (var i = 0; i < ntms.length; i++) ntms[i].addEventListener(mLstnr[2], f_ev_start, {
								passive: !0
						...
						function f_ev_move(evt) {
								...
								if (el.style.transition = "margin 0ms", xDown) {
										...
										xDiff = xDown - xUp, xDiff < 20 && xDiff > -20 || (xDiff < -20 ? el.style.marginLeft = Math.abs(xDiff) + "px" : el.style.marginLeft = "-" + xDiff + "px", xDiff < 130 && xDiff > -130 && (el.style.opacity = "1" - Math.abs(xDiff) / 130))
								}
						}

						function f_ev_end(evt) {
								var el = evt.target.closest("div.news_item");
								xDiff > 130 || xDiff < -130 ? (el.parentNode.removeChild(el), fc_ns()) : (el.style.transition = "margin 600ms", el.style.opacity = "1", el.style.marginLeft = "4px"), xDiff = xDown = null
						}
				}

				function fc_ns() {
						if (void 0 === localStorage.cachedNewsUpdate || Date.now() / 1e3 - localStorage.cachedNewsUpdate >= .1) {
								const y = ntp_sett.order[2];
								ntp_wdg[2].cached = document.getElementById("wdg_" + y).innerHTML, localStorage.cachedNewsUpdate = Date.now() / 1e3, console.log("Cache news section : " + localStorage.cachedNewsUpdate)
						}
						localStore("ntp_wdg", ntp_wdg)
				}

				function f_tnv() {
						"150px" == getComputedStyle(ntp_bdy).getPropertyValue("--o4") ? ntp_bdy.style.setProperty("--o4", "auto") : ntp_bdy.style.setProperty("--o4", "150px"), save_ntpbdy(), fc_ns()
				}

				function f_nsrl(t) {
						1 != t && 2 != t || (localStorage.removeItem("itemsNews"), localStorage.newsLe = document.getElementById("newsL").value, document.getElementById("news").innerHTML = "", 2 == t && ntoast.success("Fetched news cleaned !")), localStorage.removeItem("cachedNewsUpdate"), forceReload = !0, loadGNews(), window.setTimeout((function () {
								f_astd()
				...
				function render_gnews(answer) {
						...
						for (var i = articles.length - 1; i > 0; i--) {
								var article = articles[i],
										...
										source_logo = null,
										news_time = null;
								link = article.querySelector("a.VDXfz").href, title = article.querySelector("h4 a.DY5T1d").innerHTML;
								try {
										image = article.querySelector(".QwxBBf").src
								} catch {}
								source = article.querySelector("a.wEwyrc").innerHTML, source_logo = article.querySelector(".wsLqz source").src, news_time = {
										a: article.querySelector(".WW6dff").getAttribute("datetime"),
										b: article.querySelector(".WW6dff").innerHTML
								}, link && (link = link.replace(/.+?(?=articles)/, "https://news.google.com/")), link && image && title && add_gnews(title, news_time, source, source_logo, link, image)
						}
						fc_ns()
				}

				function loadGNews() {
						if (shouldIC() && document.getElementById("news").innerHTML, "" == document.getElementById("news").innerHTML || Date.now() / 1e3 - localStorage.cachedNewsUpdate > 3600 || forceReload) {
								forceReload = !1, console.log("Fetching news.."), render_news_loading();
								try {
										fetch(newsServer + "foryou" + localStorage.newsLe, {
												method: "GET",
												credentials: "include"
										}).then((function (response) {
												return response.url.includes("&ceid=") && (localStorage.newsLe = response.url.substr(response.url.lastIndexOf("?"))), response.text()
										})).then((function (answer) {
												render_gnews(answer), localStorage.cachedNewsUpdate = Date.now() / 1e3
										}))
								} catch (err) {
				...
				localStorage.newsLe || (localStorage.newsLe = "?hl=en-US&gl=US&ceid=US:en"), document.getElementById("newsL").value = localStorage.newsLe;
				const sel = document.getElementById("newsL");
				if (sel.options.length < 20)
						for (var el in locales) {
								var opt = document.createElement("option");
								opt.appendChild(document.createTextNode(el)), opt.value = locales[el], sel.appendChild(opt), locales[el] == localStorage.newsLe && (opt.selected = !0)
						}
				preconnectTo(newsServer), loadGNews(), window.setTimeout((function () {
						f_astd()
				}), 1e3), window.setTimeout((function () {
						f_astd()
				}), 2e3)
		...
		function toggle_widget(i) {
				...
				console.log(" Widget : " + i + " Order : " + y + " Status :" + ntp_sett.status[i] + " - >" + status), ntp_sett.status[i] = status, document.getElementById("wdg_" + y).style.display = status ? "block" : "none", customInner(document.getElementById("wdg_" + y), status ? ntp_wdg[i].cached : ""), localStore("ntp_sett", ntp_sett), ntp_sett.status[i] && 1 == i && f_setup_gtiles()
		}
		...
		function random_gradient() {
				...
				colorOne.rgb = "rgb(" + colorOne.R + "," + colorOne.G + "," + colorOne.B + ")", colorTwo.rgb = "rgb(" + colorTwo.R + "," + colorTwo.G + "," + colorTwo.B + ")";
		...
		Sortable.create(document.getElementById("stt_lwo"), {
				...
				animation: 150,
				onEnd: function (evt) {
						for (var list = document.getElementById("stt_lwo").getElementsByTagName("li"), z = 0; z < list.length; z++) {
								var y = parseInt(list[z].getAttribute("data-order"));
								ntp_sett.order[y] = z, orderListChanged = 1
						}
						load_widgets(), localStore("ntp_sett", ntp_sett), ntp_sett.status[1] && f_setup_gtiles(), ntp_sett.status[4] && f_setup_tabs(), ntp_sett.status[3] && f_setup_wth(), wait(100)
				}
		});
		...
		for (var cr, cr_img = "", img_w = wDevice / 2.5, img_h = hDevice / 2.5, isCrop = 0; img_w > 670;) img_w /= 1.2, img_h /= 1.2;
		ntp_bdy.style.setProperty("--bg-cw", img_w + "px"), ntp_bdy.style.setProperty("--bg-ch", img_h + "px");
		...
		function savebg_cropped(t) {
				ntp_bdy.style.setProperty("--bg-img-l", "url(" + imgRes.src + ")"), ntp_bdy.style.setProperty("--bg-img-d", "var(--bg-img-l)"), ntp_bdy.style.setProperty("--bg-cl", "#fff"), save_ntpbdy(), ntoast.success(" Background saved !"), cropCancel()
		}
		...
		function random_gradient() {
				...
				return colorOne.rgb = "rgb(" + colorOne.R + "," + colorOne.G + "," + colorOne.B + ")", colorTwo.rgb = "rgb(" + colorTwo.R + "," + colorTwo.G + "," + colorTwo.B + ")", "radial-gradient(at top left, " + colorOne.rgb + ", " + colorTwo.rgb + ")"
		}
		...
		function f_wallp1(a) {
				...
				if (file && file.type.match("image.*")) {
						var reader = new FileReader;
						reader.onload = function (e) {
								bg_pld.style.display = "none", "" == cr_img ? (cr_img = e.target.result, cropInit()) : (cr_img = e.target.result, bindCropImg()), crop.style.display = "inline"
						}, reader.readAsDataURL(file)
				}
		}
		...
		function f_wallp2() {
				var url = prompt("Enter url of the wallpaper . \nExample : ", "url"),
						image = new Image;
				image.crossOrigin = "Anonymous", image.onload = function (e) {
						bg_pld.style.display = "none", "" == cr_img ? (cr_img = image.src, cropInit()) : (cr_img = image.src, bindCropImg()), crop.style.display = "inline"
				}, image.src = url
		}

		function f_wallp3(a) {
				var rg = random_gradient();
				document.body.style.setProperty("--bg-img-" + a, rg), document.getElementById("wllp_value_" + a).value = rg
		}

		function f_wallp4(a) {
				var v = document.getElementById("wllp_value_" + a).value;
				document.body.style.setProperty("--bg-img-" + a, v), document.body.style.setProperty("--bg-c" + a, v), save_ntpbdy(), ntoast.success(" Background saved !")
		}
		...
		function cropCancel() {
				"none" == bg_pld.style.display && (bg_pld.style.display = "inline", crop.style.display = "none", result.style.display = "none", wllp_file_l.value = "", wllp_file_d.value = "", isCrop = 0)
		}

		function cropResult() {
				isCrop || (isCrop = 1, cr.result({
						type: "base64",
						size: "{width:wDevice, height:hDevice}",
						format: "jpeg",
						quality: 1
				}).then((function (resp) {
						crop.style.display = "none", imgRes.src = resp, result.style.display = "inline"
				})))
		}
